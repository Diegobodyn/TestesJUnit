...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "João", 31, "joaojava@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Pedro", 34, "pedrojava@gmail.com", conta02.getId(), true);
